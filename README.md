...
- 앱 내부 저장본을 개별 삭제하는 UI는 0.1.5에 없습니다. 내보낸 뒤 필요하면 Android 앱 설정에서 저장공간을 관리하세요.
...
Android 11(API 30) 이상이며 target SDK는 35입니다. 패키지는 `com.polestar.dashcamexporter`, 표시 이름은 **Dashcam Exporter**, 버전은 **0.1.5**입니다. Debug 서명 APK로 제공하며 OEM 시스템 UID나 OEM 서명을 사용하지 않습니다. 자동차 런처의 노출 및 일반 앱 설치 허용 여부는 차량 정책에 따릅니다.
